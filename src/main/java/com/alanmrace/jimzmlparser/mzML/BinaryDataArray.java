...
public class BinaryDataArray extends MzMLContent  implements Serializable {
	...
	/** Accession: Binary data compression type (MS:1000572). MUST supply a child only once */
...
//	    System.out.println("DataType: " + dataType);
		...
		case BinaryDataArray.singlePrecisionID:
		    ...
		    break;
		case BinaryDataArray.imsSigned64bitIntegerID:
		case BinaryDataArray.signed64bitIntegerID:
		    ...
		    break;
		case BinaryDataArray.imsSigned32bitIntegerID:
