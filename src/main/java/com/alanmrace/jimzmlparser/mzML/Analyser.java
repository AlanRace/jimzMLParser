...
public class Analyser extends MzMLContent implements Serializable {
	...
	/** Accession: Mass analyser type (MS:1000443). MUST be supplied (or any children) only once. */
	public static String analyserTypeID = "MS:1000443";
	
	/** Accession: Mass analyser attribute (MS:1000480). MAY supply a child one or more times. */
