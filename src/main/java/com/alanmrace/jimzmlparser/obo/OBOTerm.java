...
public class OBOTerm implements Serializable {
    ...
    /**
     * List of Strings containing all values which were listed as relationship:
     * has_units.
     */
    ...
    /**
     * List of all child terms of this ontology term. These are determined as
     * the inverse of any relationship: is_a that is encountered.
     */
    ...
    public enum XMLType {
         ...
         * <li>T indicates the start of a time section (required if you are
         ...
         *
         * @see
         * <a href="https://www.w3schools.com/xml/schema_dtypes_date.asp">https://www.w3schools.com/xml/schema_dtypes_date.asp</a>
         */
        DURATION,
        /**
         * Date and time.
         *
         * <p>
         * Expected DateTime format is [-]CCYY-MM-DDThh:mm:ss[Z|(+|-)hh:mm]
         *
         * @see
         * <a href="http://books.xmlschemata.org/relaxng/ch19-77049.html">http://books.xmlschemata.org/relaxng/ch19-77049.html</a>
         * @see
         * <a href="https://www.w3schools.com/xml/schema_dtypes_date.asp">https://www.w3schools.com/xml/schema_dtypes_date.asp</a>
         */
        DATETIME,
        ...
        DATE,
        /**
         * A period of one calendar month for a specific year, in the format
         * YYYY-MM.
         */
        GYEARMONTH,
        /**
        ...
        GYEAR,
        /**
         * The period of one calendar day recurring each calendar year, in the
         * format --MM-DD (with an optional timezone).
         */
        GMONTHDAY,
        /**
         * The period of one calendar day, recurring each calendar month, in the
         * format ---DD (with an optional timezone).
         */
        GDAY,
        /**
         * The period of one calendar month recurring each year, in the format
         * --MM (with an optional timezone).
         */
        GMONTH,
        /**
         * Representation of binary data as a sequence of binary octets using
         * hexadecimal encoding. Each binary octet is a two-character
         * hexadecimal number.
         */
        HEXBINARY,
        /**
         ...
         *
         * @see
         * <a href="http://books.xmlschemata.org/relaxng/ch19-77287.html">http://books.xmlschemata.org/relaxng/ch19-77287.html</a>
         */
        QNAME,
        /**
    ...
    /**
     * The value type allowed for the ontology term, or null if no value
     * expected.
     */
    ...
    public enum Synonym {
        ...
        EXACT,
        /**
         * A synonym for a class C is BROAD if it denotes a broader class than
         * C.
         *
         * <p>
         * Here, broader than is an informal notion that encompasses both
         * subsumption and possibly mereological and temporal containment. For
         * example, "skull" could conceivably be a BROAD synonym for the class
         * cranium.
         *
         * @see
         * <a href="http://owlcollab.github.io/oboformat/doc/obo-syntax.html">OBO
        ...
        BROAD,
        /**
         * A synonym for a class C is NARROW if C denotes a broader class than
         * the synonym.
         *
         * <p>
     ...
     *
     * @param strippedLine Single line from an OBO file with all preceding and
     * proceeding white characters removed.
     */
    ...
    /**
     * Get the expected value type for the ontology term, or null if no value
     * expected.
     *
     * @return Value type
     */
    ...
    /**
     * Check whether a given id is that of any parent to the current ontology
     * term.
     *
     * @param id ID of the potential parent term
     * @return true if a parent term is found to have the specified id, false
     * otherwise
     */
    ...
    /**
     * Check whether a given id is that of any child to the current ontology
     * term.
     *
     * @param id ID of the potential child term
     * @return true if a child term is found to have the specified id, false
     * otherwise
     */
     ...
     *
     * @param includeThis Whether to include the current OBOTerm in the list of
     * returned children
    ...
    /**
     * Get all terms which have been previously added as parent terms, as well
     * as all of their parent terms (repeated recursively).
     *
     * @param includeThis Whether to include the current OBOTerm in the list of
     * returned parents
    ...
    /**
     * Get all terms which have been previously added as parent terms, as well
     * as all of their parent terms (repeated recursively) and add to the
     * specified allParents list.
     *
    ...
    /**
     * Check whether any of the parents, or their parents (checked recursively),
     * is the specified term.
     *
    ...
    /**
     * Add a unit ontology term which describes the units for the value of this
     * ontology term. Determined by has_units relationship in the OBO file.
     *
